  ...
  return (
    <div className="service component__space" id="Services">
      <div className="heading">
        ...
        <p className="heading p__color">Below are my skills,</p>
        <p className="heading p__color">
          and i thrive to learn new technologies to make myself productive in
          ...
          <div className="col__3">
            <div className="service__box pointer">
              ...
              <div className="service__meta">
                ...
                <p className="p service__text p__color">* React Native</p>
              </div>
            </div>
          </div>
          ...
          <div className="col__3">
            <div className="service__box pointer">
              ...
              <div className="service__meta">
                ...
                <p className="p service__text p__color">* Trello</p>
                <p className="p service__text p__color">* Jira</p>
              </div>
            </div>
          </div>
